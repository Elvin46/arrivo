...
public interface IRestaurantService
{
    ...
    Task<RestaurantDto> UpdateAsync(Guid id, UpdateRestaurantRequest request, string requestingUserId, bool isAdmin = false, CancellationToken ct = default);
    Task SetStatusAsync(Guid id, bool activate, CancellationToken ct = default);
